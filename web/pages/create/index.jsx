...
import  TokenFactoryABI from '../../contract_data/contract_Tok.json';
import TokenFactoryByteCode  from "../../contract_data/byteCode_Tok";
...
const Create = () => {
  ...
  const pinFileToIPFSMain = async () => {
    ...
    const signer = await provider.getSigner(account);
      try {
        ...
        console.log(TokenFactoryByteCode);
        console.log(NFTMarketplaceABI);
        console.log(NFTMarketplaceAddress);
        const factory = new ethers.ContractFactory(TokenFactoryABI, TokenFactoryByteCode, signer);
        const contract = await factory.deploy(100,NFTMarketplaceAddress,"UNMONEYY" , "UNI");
  ...
  return (
    <div>
      <Meta title="Create || ClosedC | NFT Marketplace " />
      {/* <!-- Create --> */}
