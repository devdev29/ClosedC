...
// export const magicProvider = new Magic('pk_live_67EBF66C23746DDF', {
//   network: {
//     rpcUrl: 'https://sepolia.infura.io/v3/a795e99cf21d40669aaee8f821b99b67',
//     chainId: 11155111,
...
const MblNavbar = ({ theme }) => {
  ...
  // const magic = new Magic('pk_live_67EBF66C23746DDF', { 
  //   network: "sepolia",
  // });
          ...
          <ul className="flex flex-col lg:flex-row">
            ...
            <li className="js-nav-dropdown nav-item dropdown group relative">
              <button
                ...
                onClick={(e) => handleItemDropdown(e)}
              >
                <Link href="/collection/explore_collection"><span className={navText === "collection" ? "text-accent" : ""}>
                  Explore
                </span>
</Link>
                <i className="lg:hidden">
